...
export declare class Token {
     ...
     * @memberof Token
     */
    createOp(walletAddress: string, nonce: NumberLike, paymasterAndData: string, maxFeePerGas: NumberLike, maxPriorityFeePerGas: NumberLike, callContract: string, data: string): UserOperation;
}
/**
 * erc20 token class
 * @class ERC20
